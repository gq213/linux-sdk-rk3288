...
[ -f ${TARGET_DIR}/etc/init.d/S40network ] && \
    mv ${TARGET_DIR}/etc/init.d/S40network ${TARGET_DIR}/etc/init.d/mS40network
[ -f ${TARGET_DIR}/etc/init.d/S49ntp ] && \
    mv ${TARGET_DIR}/etc/init.d/S49ntp ${TARGET_DIR}/etc/init.d/mS49ntp
#[ -f ${TARGET_DIR}/etc/init.d/S49weston ] && \
#    mv ${TARGET_DIR}/etc/init.d/S49weston ${TARGET_DIR}/etc/init.d/mS49weston

cp ${TARGET_DIR}/../../../../linux/bsp/external/broadcom_bsa/test_files/av/48k16bpsStereo.wav ${TARGET_DIR}/etc/ -a
